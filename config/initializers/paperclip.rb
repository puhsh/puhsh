...
Paperclip::Attachment.default_options[:url] = Rails.env.production? ? ':s3_alias_url' : ':s3_domain_url'
Paperclip::Attachment.default_options[:s3_host_alias] = Rails.env.production? ? 'd1fakcx7ksmski.cloudfront.net' : nil
