...
ActiveRecord::Schema.define(version: 20140423172103) do
  ...
  add_index "app_invites", ["status"], name: "index_app_invites_on_status", using: :btree
  add_index "app_invites", ["status"], name: "index_waiting_lists_on_status", using: :btree
  add_index "app_invites", ["user_id"], name: "index_app_invites_on_user_id", using: :btree
  ...
  add_index "cities", ["name"], name: "index_cities_on_city", using: :btree
  ...
  add_index "events", ["user_id", "resource_id", "resource_type", "controller_name", "controller_action"], name: "index_unique_event_user_resource", unique: true, using: :btree
  ...
  add_index "facebook_test_users", ["fbid"], name: "index_facebook_test_users_on_fbid", unique: true, using: :btree
  ...
  add_index "flagged_posts", ["post_id"], name: "index_flagged_posts_on_post_id", using: :btree
  add_index "flagged_posts", ["user_id"], name: "index_flagged_posts_on_user_id", using: :btree
  ...
  add_index "followed_cities", ["city_id"], name: "index_followed_cities_on_city_id", using: :btree
  add_index "followed_cities", ["user_id"], name: "index_followed_cities_on_user_id", using: :btree
  ...
  add_index "invites", ["uid_invited"], name: "index_invites_on_uid_invited", using: :btree
  ...
  add_index "item_transactions", ["buyer_id"], name: "index_item_transactions_on_buyer_id", using: :btree
  add_index "item_transactions", ["item_id"], name: "index_item_transactions_on_item_id", using: :btree
  add_index "item_transactions", ["offer_id"], name: "index_item_transactions_on_offer_id", using: :btree
  add_index "item_transactions", ["payment_type"], name: "index_item_transactions_on_payment_type", using: :btree
  add_index "item_transactions", ["post_id"], name: "index_item_transactions_on_post_id", using: :btree
  add_index "item_transactions", ["seller_id"], name: "index_item_transactions_on_seller_id", using: :btree
  ...
  add_index "notifications", ["actor_type"], name: "index_notifications_on_actor_type", using: :btree
  add_index "notifications", ["content_id"], name: "index_notifications_on_content_id", using: :btree
  add_index "notifications", ["content_type"], name: "index_notifications_on_content_type", using: :btree
  ...
  add_index "questions", ["item_id"], name: "index_questions_on_item_id", using: :btree
  ...
  add_index "stars", ["subject_id", "subject_type"], name: "index_stars_on_subject_id_and_subject_type", using: :btree
  ...
  add_index "wall_posts", ["post_type"], name: "index_wall_posts_on_type", using: :btree
  ...
  add_index "zipcodes", ["city_name"], name: "index_zipcodes_on_city_name", using: :btree
  add_index "zipcodes", ["code"], name: "index_zipcodes_on_code", using: :btree
  add_index "zipcodes", ["latitude"], name: "index_zipcodes_on_latitude", using: :btree
  add_index "zipcodes", ["longitude"], name: "index_zipcodes_on_longitude", using: :btree
